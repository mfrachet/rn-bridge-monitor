...
export default class BridgeMonitor {
   ...
   * - moderated is the default one meaning that it will only display the implemented modules / methods in the output
   * - all will display absolutely all the messages that pass through the bridge. Quite laggy and not performant at all
   */
